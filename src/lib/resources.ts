...
export const slideResources: Resource[] = [
  ...
  { title: 'Day 3 — Evaluation & Study Design (Joshi) — HTML deck', file: 'slides/day3-evaluation.html' },
  { title: 'Day 3 — Evaluation & Study Design (Joshi) — PDF', file: 'slides/day3-evaluation.pdf' },
  { title: 'Day 3 — Evaluating AI methods vs. models (Salaudeen)', file: 'slides/day3-salaudeen.pdf' },
