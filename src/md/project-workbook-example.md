...
- **Bottom line:** *ADT + vitals + hourly census, retrospective, IRB +
...
- **Bottom line:** *Success = net benefit at the action threshold, well
...
- **Bottom line:** *GBT on tabular features incl. live census; logistic
...
- **People & approvals.** Bed-management lead (champion), ED operations, IT/EHR
  ...
  monitoring.
- **Bottom line:** *Flag on the ops dashboard at admission. Top failure:
